...
var (
	...
	ErrDivisionNotEmpty         = errors.New("persistent: the division is not empty")
	ErrDivisionNotFound         = errors.New("persistent: error of searching the division: not found")
	ErrDivisionNotSuperdivision = errors.New("persistent: the division is not superdivision")
